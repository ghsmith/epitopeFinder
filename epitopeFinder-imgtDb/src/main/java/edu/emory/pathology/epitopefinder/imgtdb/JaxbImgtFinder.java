...
import edu.emory.pathology.epitopefinder.imgtdb.jaxb.imgt.Alleles;
import java.io.File;
...
public class JaxbImgtFinder {
    ...
    public Alleles getAlleles() {
        if(alleles == null) {
            try {
                JAXBContext jc0 = JAXBContext.newInstance("edu.emory.pathology.epitopefinder.imgtdb.jaxb.imgt");
